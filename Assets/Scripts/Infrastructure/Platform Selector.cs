...
namespace Infrastructure
{
    public static partial class Tools
    {
        ...
        /// </summary>
        public static bool TryGetPlatform(this Tilemap tilemap, Vector3Int start, Predicate<Vector3Int> predicate, out Vector3Int[] platformCoords)
        {
            platformCoords = Array.Empty<Vector3Int>();
            ...
            platformCoords = new Vector3Int[rightX - leftX + 1];

            for (int i = 0; i < platformCoords.Length; i++)
                platformCoords[i] = new Vector3Int(leftX++, y, z);
