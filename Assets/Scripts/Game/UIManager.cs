...
namespace Game
{
    ...
    public class UIManager : MonoBehaviour
    {
        ...
        // Content
        public void RegisterModel(IViewModel viewModel)
        {
            if (viewModel == null)
                throw new ArgumentNullException(nameof(viewModel), Ctx(
                    "등록할 인자는 null일 수 없습니다."));
        ...
        {
            if (view == null)
                throw new ArgumentNullException(nameof(view), Ctx(
                    "등록할 인자는 null일 수 없습니다."));
